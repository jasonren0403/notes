...
* <a name="bg-style"></a>背景样式
    ...
    * <a name="bg-size"></a>background-size
    ...
    * <a name="bg-attachment"></a>background-attachment
...
- 块级元素、行内元素和盒模型
	...
	=== "块级元素<a name='block-element'></a>"
		* 有宽、高，可定义四个方向的`margin`
		* 默认从上到下排列，占据整行

    === "行内元素<a name='inline-element'></a>"
